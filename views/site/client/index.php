...
<body>
	...
	<video width="640" height="360" controls>
		<!-- Inclua o caminho do arquivo de vídeo ou a URL do vídeo -->
		<source src="<?php echo $url; ?>/assets/video/configurar gtin.mp4" type="video/mp4">
		<source src="seu_video.webm" type="video/webm">
