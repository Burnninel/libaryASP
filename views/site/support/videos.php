...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $url; ?>/assets/css/support/dashboard.css">
...
<body>
    <main id="main">
        ...
        <div id="visualMedia">
            <div id="headearSupportDashboard"><?= $title ?></div>
	...
	<script src="<?php echo $url; ?>/assets/js/site/support/videoDashboard.js"></script>
